...
-->
![Skills](https://skills-icons.vercel.app/api/icons?i=python,linux,docker,bun,html,css,bootstrap,tailwindcss,motion,radixui,figma,git,javascript,typescript,vite,react,redux,nextjs,zustand,vuejs,pinia,astro,nodejs,expressjs,trpc,jwt,mongodb,postgresql,drizzle,supabase,java,spring)
